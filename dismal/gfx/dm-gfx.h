...
enum {
  ...
  /* Flags */
  DM_GFX_AUTO_RESIZE = (1<<0), /**< If set, then all coordinates and
...
struct dm_GfxDriverSpec {
  ...
  void (*reg)(dm_GfxDriver *driver); /**< Pointer to the function that
...
struct dm_GfxDriver {
  ...
  int   (*draw_image)(struct dm_GfxImageNode *image, 
                      ...
                      unsigned int width, 
                      unsigned int height);
  void  (*fill_rect_rgb)(unsigned int x, 
                         unsigned int y, 
                         unsigned int w,
                         unsigned int h,
                         unsigned int r,
                         unsigned int g,
                         unsigned int b);
  void  (*fill_rect_pal)(unsigned int x, 
                         unsigned int y, 
                         unsigned int w,
                         unsigned int h,
                         unsigned int index); 
